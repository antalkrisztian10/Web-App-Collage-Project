    ...
    <div class="grid-x grid-padding-x">
        <div class="large-12 cell">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
                ...
                $sql = "SELECT * FROM admin_products WHERE id='$id'";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['id'])) {
                ...
                if (!empty($_FILES['image_url']['name'])) {
                    ...
                    if (move_uploaded_file($_FILES['image_url']['tmp_name'], $target_file)) {
                        $sql_upd = "UPDATE admin_products SET name='$name', description='$description', price='$price', image_url='$target_file' WHERE id='$id'";
                    } else {
                        echo "<p>Failed to upload image</p>";
                        $sql_upd = "UPDATE admin_products SET name='$name', description='$description', price='$price' WHERE id='$id'";
                    }
                } else {
                    $sql_upd = "UPDATE admin_products SET name='$name', description='$description', price='$price' WHERE id='$id'";
                }
